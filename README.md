...
This module enables saltsack to store and retirve secrets from Free Ipa vault reaching a very high grade of security, by multiple tecnologies as GPG , Ipa Vault and pyarmor
